...
/**
 * Ventana para la seleccion de ECG relacionados con un paciente para poder
 * posteriormente compararlos en la misma ventana
 * 
 * @author HeartLight
 * 
 * @version Final
...
public class CompararECG extends JFrame {
	...
	/**
	 * Primera subventana en la que a traves de dos jlist se pueden seleccionar los
	 * ecg que se desean comparar
	 * 
	 * @param ecg
	 *            Todos los ecg disponible para la comparacion
	 */
	 ...
	 * Getter de JList
	 * 
	 * @return la JList en donde se encuentra los ecg que aun no estan seleccionados
	 *         para comparar
	 */
	...
	/**
	 * Segunda subventana en la que se plasman los ECG seleccionado que se desean
	 * comparar
	 * 
	 * @param ecg
	...
	public void Comparacion(Vector<ECG> ecg) {
		...
		for (int i = 0; i < ecg.size(); i++) {
			JPanel pan = new JPanel();
			if (ecg.size() - 2 <= 0 || (ecg.size() - i) % 2 != 0) {
